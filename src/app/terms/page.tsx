                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-8 md:p-12">
                    ...
                    <div className="prose prose-gray max-w-none space-y-8 text-gray-700 text-sm leading-relaxed">
                        ...
                        <Section title="1. Acceptance of Terms">
                            <p>By accessing or using Smart Business Assistant ("the Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use the Service.</p>
                            <p>These Terms apply to all users, including individuals and businesses, who access or use the Service. The Smart Business Assistant platform is designed for small and medium-sized enterprises (SMEs), particularly in Uganda and the East African region.</p>
                        </Section>

                        <Section title="2. Description of Service">
                            <p>Smart Business Assistant is an AI-powered business intelligence platform that enables users to:</p>
                            <ul>
                        ...
                        <Section title="6. Financial Data Disclaimer">
                            ...
                            <p>Smart Business Assistant is not a licensed financial institution, accounting firm, or tax advisor. You should consult a qualified financial professional before making major business decisions based on data from the Service.</p>
                        ...
                        <Section title="9. Limitation of Liability">
                            <p>To the maximum extent permitted by applicable law, Smart Business Assistant and its operators shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, data, or business opportunities, arising from your use of or inability to use the Service.</p>
                        </Section>
                        ...
                        <Section title="11. Contact Us">
                            <p>If you have any questions about these Terms of Service, please contact us through the Smart Business Assistant platform or reach out to the development team.</p>
                        </Section>
                    </div>
                </div>
            </main>
